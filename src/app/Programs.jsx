  ...
  const programs = [
    {
      ...
      image: "/cet2.jpeg?height=300&width=500",
      areas: [
    ...
    },
    {
      ...
      image: "/cet.png?height=300&width=500",
      areas: [
    ...
    },
    {
      ...
      image: "/cett.webp?height=300&width=500",
      areas: [
    ...
    <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground">
          Explore our diverse range of doctoral programs designed to push the
      ...
      <div className="space-y-16">
        {programs.map((program) => (
          <section key={program.id} id={program.id} className="scroll-mt-20">
            ...
            <Tabs defaultValue="areas" className="mt-8">
              ...
              <TabsContent value="areas" className="p-4 border rounded-lg mt-2">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Minimum of 18 credit hours of graduate-level courses.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium">Qualifying Examination</h4>
                    <p className="text-muted-foreground">
                      Must be completed within the first two years of the
                      program.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Original research contribution to the field, defended
                      before a committee.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      At least two publications in peer-reviewed journals or
                      conferences.
                    </p>
                  </div>
                </div>
